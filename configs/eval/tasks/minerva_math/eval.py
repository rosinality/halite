...
def record_to_input(record: Record) -> dict[str, str]:
    return {
        "prompt": "Problem:" + "\n" + record.problem + "\n\n" + "Solution:",
        "answer": normalize_final_answer(
            remove_boxed(last_boxed_only_string(record.solution))
        ),
    }


def fewshot_samples() -> list[dict]:
    return [
        {
...
def evaluate(doc: Record, results: List[str]) -> Dict[str, int]:
